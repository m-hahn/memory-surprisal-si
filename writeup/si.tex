...
\definecolor{baseline}{HTML}{F8766D} % red
\definecolor{real}{HTML}{00BFC4} % green-blue
\definecolor{fitted}{HTML}{7CAE00} % red-green
...
%In the Discussion of the main paper, we argued that, while smaller data sets bias towards lower values of $I_t$, and therefore towards overall less efficient tradeoff curves
